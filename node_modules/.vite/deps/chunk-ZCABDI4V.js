...
function applyCompletion(view, option) {
  ...
  if (typeof apply == "string") {
    view.dispatch(view.state.changeByRange((range) => {
      ...
      if (!range.empty || len && view.state.sliceDoc(range.from - len, range.from) != view.state.sliceDoc(result.from, result.to))
        return { range };
      return {
...
//# sourceMappingURL=chunk-ZCABDI4V.js.map
